      ...
      <Container>
        <div className="rounded-2xl border bg-gray-50 p-10 md:p-14 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-bold text-gray-900">Start gratis i dag</h2>
          ...
          <div className="flex gap-3">
            ...
            <Link
              href="/timeliste-mal"
              className="inline-flex rounded-lg border border-gray-300 bg-white px-6 py-3 font-medium text-gray-900 hover:bg-gray-100"
            >
              Se timeliste mal
            </Link>
          </div>
